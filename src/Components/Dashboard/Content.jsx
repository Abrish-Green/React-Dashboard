        ...
        <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
            ...
            <div class="bg-white p-8 rounded-md w-full">
                <div class=" flex items-center justify-between pb-6">
                    <div>
                        <h2 class="hidden md:flex text-gray-600 font-semibold text-3xl">Users</h2>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex bg-gray-50 items-center p-2 rounded-md">
                            ...
                            <input class="bg-gray-50 outline-none ml-1 block w-full border-b-2 border-slate-700" type="text" name="" id="" placeholder="search..." />
                    </div>
            ...
            © 2019-2021 <a href="https://themesberg.com" class="hover:underline" target="_blank">Themesberg</a>. All rights reserved.
            </p>
            </div>
    </React.Fragment>
  )
