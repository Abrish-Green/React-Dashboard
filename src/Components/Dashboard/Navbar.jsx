            ...
            <div className="px-3 py-3 lg:px-5 lg:pl-3">
                <div className="flex items-center justify-between">
                    <div className="flex items-center justify-start">
                        ...
                        <span className="text-2xl self-center whitespace-nowrap text-cyan-800 md:text-3xl">Company</span>
                        </a>
                   
            </div>
            <div className="flex items-center">
                      
            <a href="" className="inline-flex ml-5 text-cyan-800 hover:text-cyan-600 font-bold rounded-lg text-md px-5 py-2.5 text-center items-center mr-3">
                Logout
            </a>
            </div>
            </div>
